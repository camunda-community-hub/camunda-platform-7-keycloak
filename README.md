...
| `proxyUri` | The uri of the proxy to use. Default: `null`, example: `http://proxy:81` |
| `proxyUser` | The username needed to use the proxy. Default: `null` |
| `proxyPassword` | The password needed to use the proxy. Default: `null` |
<!--
