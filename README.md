...
| `truststore`                      | Optional file path to a truststore file. Default: `null`. In the default case the default Java truststore will be used.                                                                                                                                                                                                                                                                                                                 |
| `truststorePassword`              | Optional password for the truststore. Default: `null`.                                                                                                                                                                                                                                                                                                                                                                                  |
